...
test_that("La fonction extract_map_plot retourne une erreur si nom des variables de climat incorrect", {
  ...
  expect_error(extract_map_plot(file=liste_place, liste_raster="cartes_climat", variable=variables),"Nom des variables de climat demandees incorrect")
})
test_that("La fonction extract_map_plot retourne une erreur si nom des variables de sol incorrect", {
  liste_place <- fic_test
  variables <- c("cec", "clay")
  expect_error(extract_map_plot(file=liste_place, liste_raster="cartes_sol", variable=variables),"Nom des variables de sol demandees incorrect")
})
test_that("La fonction extract_map_plot retourne une erreur si nom des variables de IQS incorrect", {
  ...
  expect_error(extract_map_plot(file=liste_place, liste_raster="cartes_iqs", variable=variables),"Nom des variables d'IQS demandees incorrect")
})
test_that("La fonction extract_map_plot retourne une erreur si nom des variables de station incorrect", {
  ...
  expect_error(extract_map_plot(file=liste_place, liste_raster="cartes_station", variable=variables),"Nom des variables de station demandees incorrect")
})
test_that("La fonction extract_map_plot retourne une erreur si profondeur incorrecte", {
  liste_place <- fic_test
  variables <- c("cec", "argile")
  expect_error(extract_map_plot(file=liste_place, liste_raster="cartes_sol", variable=variables, profondeur = 3),"Profondeur des proprietes de sol demandee incorrecte")
})
test_that("La fonction extract_map_plot retourne une erreur si nom du raster_incorrect", {
  liste_place <- fic_test
  variables <- c("cec", "argile")
  expect_error(extract_map_plot(file=liste_place, liste_raster="cartes", variable=variables),"Nom du raster demande incorrect")
})
